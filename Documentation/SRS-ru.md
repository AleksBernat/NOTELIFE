...
2. [Todoist](https://ru.todoist.com) - Имеет возможность работы на 12 платформах. Однако довольно сложен в использовании для пользователей с минимальной технической грамотностью.
